...
from background_replacer.utils.transforms import get_train_transforms, get_val_transforms
...
class SegmentationDataModule(torch.utils.data.DataLoader):
    ...
    def setup(self, stage=None):
        self.train_ds = SegmentationDataset(self.image_dir + "/train/images", self.mask_dir + "/train/masks", get_train_transforms())
        self.val_ds = SegmentationDataset(self.image_dir + "/val/images", self.mask_dir + "/val/masks", get_val_transforms())
